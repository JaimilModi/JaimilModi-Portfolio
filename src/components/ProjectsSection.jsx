...
const projects = [
  {
    ...
    title: "Run-Craft",
    description:
      "A modern browser-based code editor for writing, running, and managing code snippets with real-time execution and a sleek developer-focused UI.",
    image: "/projects/run-craft.png",
    tags: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
    ...
    Url: "https://run-craft.vercel.app/",
  },
  {
    id: 2,
    title: "SnappyTalk",
